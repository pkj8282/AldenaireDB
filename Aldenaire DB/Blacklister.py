import discord, datetime, pytz, json
...
def get_json():
    with open(CONFIG['BlackList File Name'], 'r', encoding='utf-8') as f:
        return json.load(f)
...
@Bot.tree.command(name="blacklist", description="연결된 엘덴에어 DB를 통해 확인된 인원을 차단합니다.")
